...
export default function Jemput() {
  const data = kurirData.tasks.filter((item) => item.jenis === "Penjemputan");
  const completedCount = data.filter((item) => item.status === "Dijemput").length;
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
          <p className="text-xs text-blue-600 font-inter-semibold uppercase mb-1">Total Penjemputan</p>
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow">
        <div className="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
          ...
          <p className="text-sm text-gray-500 mt-1">{data.length} penjemputan akan dilakukan</p>
        </div>
                  ...
                  <td colSpan="6" className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-500 font-poppins">
                        Semua penjemputan telah selesai!
                      </p>
                    </div>
                  </td>
                </tr>
